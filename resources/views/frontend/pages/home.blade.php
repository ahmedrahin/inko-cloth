            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="slider-wrap">
                        <div class="sld_image">
                            <img src="{{ asset('frontend/images/slider/slider-1.jpg') }}" data-src="{{ asset('frontend/images/slider/slider-1.jpg') }}" alt="Image" class="lazyload">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="slider-wrap">
                        <div class="sld_image">
                            <img src="{{ asset('frontend/images/slider/slider-2.jpg') }}" data-src="{{ asset('frontend/images/slider/slider-2.jpg') }}" alt="Image" class="lazyload">
                        </div>
                        <div class="sld_content">
                            <div class="container">
                                <div class="content-sld_wrap">
                                    <h1 class="title_sld text-display fade-item fade-item-1">Spring Summer <br class="d-sm-none">Collection</h1>
                                    <p class="sub-text_sld h5 text-black fade-item fade-item-2">
        ...
        <div dir="ltr" class="swiper tf-swiper" data-preview="3" data-tablet="2" data-mobile-sm="2" data-mobile="1" data-pagination="1"
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="wg-cls-2 d-flex hover-img">
                        <a href="shop-default.html" class="image img-style">
                            <img class="lazyload" src="{{ asset('frontend/images/collections/cls-1.jpg') }}" data-src="{{ asset('frontend/images/collections/cls-1.jpg') }}" alt="Slider">
                        </a>
                        <div class="cls-content_wrap b-16">
                            <div class="cls-content">
                                <a href="shop-default.html" class="tag_cls h3 link">Clothing</a>
                                <span class="br-line type-vertical"></span>
                                <a href="shop-default.html" class="tf-btn-line text-nowrap"> Shop now </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide">
                    <div class="wg-cls-2 d-flex hover-img">
                        <a href="shop-default.html" class="image img-style">
                            <img class="lazyload" src="{{ asset('frontend/images/collections/cls-2.jpg') }}" data-src="{{ asset('frontend/images/collections/cls-2.jpg') }}" alt="Slider">
                        </a>
                        <div class="cls-content_wrap b-16">
                            <div class="cls-content">
                                <a href="shop-default.html" class="tag_cls h3 link">Trending</a>
                                <span class="br-line type-vertical"></span>
                                <a href="shop-default.html" class="tf-btn-line text-nowrap"> Shop now </a>
                            </div>
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="wg-cls-2 d-flex hover-img">
                        <a href="shop-default.html" class="image img-style">
                            <img class="lazyload" src="{{ asset('frontend/images/collections/cls-3.jpg') }}" data-src="{{ asset('frontend/images/collections/cls-3.jpg') }}" alt="Slider">
                        </a>
                        <div class="cls-content_wrap b-16">
                            <div class="cls-content">
                                <a href="shop-default.html" class="tag_cls h3 link">Dresses</a>
                                <span class="br-line type-vertical"></span>
                                <a href="shop-default.html" class="tf-btn-line text-nowrap"> Shop now </a>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="sect-title wow fadeInUp">
                ...
                <ul class="tab-product_list" role="tablist">
                    ...
                    <li class="nav-tab-item" role="presentation">
                        <a href="#best-seller" data-bs-toggle="tab" class="tf-btn-line tf-btn-tab"> Best seller </a>
                    </li>
                    <li class="nav-tab-item" role="presentation">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="card-product">
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" src="images/products/product-1.jpg"
                                    ...
                                    <div class="card-product_info">
                                        ...
                                        <ul class="product-color_list">
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                ...
                                                <img src="images/products/product-1.jpg" data-src="images/products/product-1.jpg" alt="Image">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                ...
                                                <img src="images/products/product-4.jpg" data-src="images/products/product-4.jpg" alt="Image">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Orange</span>
                                                <span class="swatch-value bg-vivid-orange"></span>
                                                <img src="images/products/product-3.jpg" data-src="images/products/product-3.jpg" alt="Image">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" src="images/products/product-7.jpg"
                                    ...
                                    <div class="card-product_info">
                                        ...
                                        <ul class="product-color_list">
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                ...
                                                <img src="images/products/product-7.jpg" data-src="images/products/product-7.jpg" alt="Image">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Geige</span>
                                                <span class="swatch-value bg-light-beige"></span>
                                                <img src="images/products/product-9.jpg" data-src="images/products/product-9.jpg" alt="Image">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Olive</span>
                                                <span class="swatch-value bg-dusty-olive"></span>
                                                <img src="images/products/product-11.jpg" data-src="images/products/product-11.jpg" alt="Image">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" src="images/products/product-13.jpg"
                        ...
                        <div class="swiper-wrapper">
                                    ...
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            ...
                                            <img class="lazyload img-hover" src="images/products/underwear/product-2.jpg"
                                                data-src="images/products/underwear/product-2.jpg" alt="Product">
                                        </a>
                                        <ul class="product-action_list">
                                            <li>
                                                <a href="#shoppingCart" data-bs-toggle="offcanvas" class="hover-tooltip tooltip-left box-icon">
                                    ...
                                    <div class="card-product_info">
                                        ...
                                        <ul class="product-color_list">
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                <span class="tooltip color-filter">Sage Green</span>
                                                <span class="swatch-value bg-sage-green"></span>
                                                <img class="lazyload" src="images/products/underwear/product-1.jpg"
                                                    data-src="images/products/underwear/product-1.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Light Orange</span>
                                                <span class="swatch-value bg-tomato"></span>
                                                <img class="lazyload" src="images/products/underwear/product-3.jpg"
                                                    data-src="images/products/underwear/product-3.jpg" alt="Product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            ...
                                            <img class="lazyload img-hover" src="images/products/underwear/product-5.jpg"
                                                data-src="images/products/underwear/product-5.jpg" alt="Product">
                                        </a>
                                        <ul class="product-action_list">
                                            <li>
                                                <a href="#shoppingCart" data-bs-toggle="offcanvas" class="hover-tooltip tooltip-left box-icon">
                                    ...
                                    <div class="card-product_info">
                                        ...
                                        <ul class="product-color_list">
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                <span class="tooltip color-filter">Beige</span>
                                                <span class="swatch-value bg-light-beige"></span>
                                                <img class="lazyload" src="images/products/underwear/product-4.jpg"
                                                    data-src="images/products/underwear/product-4.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Dark</span>
                                                <span class="swatch-value bg-dark-charcoal"></span>
                                                <img class="lazyload" src="images/products/underwear/product-6.jpg"
                                                    data-src="images/products/underwear/product-6.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Green</span>
                                                <span class="swatch-value bg-dark-jade"></span>
                                                <img class="lazyload" src="images/products/underwear/product-7.jpg"
                                                    data-src="images/products/underwear/product-7.jpg" alt="Product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            ...
                                            <img class="lazyload img-hover" src="images/products/underwear/product-9.jpg"
                                                data-src="images/products/underwear/product-9.jpg" alt="Product">
                                        </a>
                                        <div class="variant-box">
                                            <ul class="product-size_list">
                                                <li class="size-item h6">XS</li>
                                    ...
                                    <div class="card-product_info">
                                        ...
                                        <ul class="product-color_list">
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                ...
                                                <span class="swatch-value bg-dusty-olive"></span>
                                                <img class="lazyload" src="images/products/underwear/product-8.jpg"
                                                    data-src="images/products/underwear/product-8.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Light Orange</span>
                                                <span class="swatch-value bg-tomato"></span>
                                                <img class="lazyload" src="images/products/underwear/product-10.jpg"
                                                    data-src="images/products/underwear/product-10.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Green</span>
                                                <span class="swatch-value bg-dark-jade"></span>
                                                <img class="lazyload" src="images/products/underwear/product-11.jpg"
                                                    data-src="images/products/underwear/product-11.jpg" alt="Product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            ...
                                            <img class="lazyload img-hover" src="images/products/underwear/product-13.jpg"
                                                data-src="images/products/underwear/product-13.jpg" alt="Product">
                                        </a>
                                        <ul class="product-action_list">
                                            <li>
                                                <a href="#shoppingCart" data-bs-toggle="offcanvas" class="hover-tooltip tooltip-left box-icon">
                                    ...
                                    <div class="card-product_info">
                                        ...
                                        <ul class="product-color_list">
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                <span class="tooltip color-filter">Green</span>
                                                <span class="swatch-value bg-dark-jade"></span>
                                                <img class="lazyload" src="images/products/underwear/product-12.jpg"
                                                    data-src="images/products/underwear/product-12.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Dusty Olive</span>
                                                <span class="swatch-value bg-dusty-olive"></span>
                                                <img class="lazyload" src="images/products/underwear/product-14.jpg"
                                                    data-src="images/products/underwear/product-14.jpg" alt="Product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" src="images/products/underwear/product-15.jpg"
                                                data-src="images/products/underwear/product-15.jpg" alt="Product">
                                            <img class="lazyload img-hover" src="images/products/underwear/product-16.jpg"
                                                data-src="images/products/underwear/product-16.jpg" alt="Product">
                                        </a>
                                        <div class="variant-box">
                                            <ul class="product-size_list">
                                                <li class="size-item h6">XS</li>
                                    ...
                                    <div class="card-product_info">
                                        ...
                                        <ul class="product-color_list">
                                            ...
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Light Orange</span>
                                                <span class="swatch-value bg-tomato"></span>
                                                <img class="lazyload" src="images/products/underwear/product-17.jpg"
                                                    data-src="images/products/underwear/product-17.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Dark</span>
                                                <span class="swatch-value bg-dark-charcoal"></span>
                                                <img class="lazyload" src="images/products/underwear/product-18.jpg"
                                                    data-src="images/products/underwear/product-18.jpg" alt="Product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" src="images/products/underwear/product-19.jpg"
                                                data-src="images/products/underwear/product-19.jpg" alt="Product">
                                            <img class="lazyload img-hover" src="images/products/underwear/product-20.jpg"
                                                data-src="images/products/underwear/product-20.jpg" alt="Product">
                                        </a>
                                        <ul class="product-action_list">
                                            <li>
                                                <a href="#shoppingCart" data-bs-toggle="offcanvas" class="hover-tooltip tooltip-left box-icon">
                                    ...
                                    <div class="card-product_info">
                                        <a href="product-detail.html" class="name-product h4 link">Elastic waist panties</a>
                                        <div class="price-wrap">
                                            <span class="price-old h6 fw-normal">$139,99</span>
                                            <span class="price-new h6">$94,99</span>
                                        </div>
                                        <ul class="product-color_list">
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                <span class="tooltip color-filter">Beige</span>
                                                <span class="swatch-value bg-light-beige"></span>
                                                <img class="lazyload" src="images/products/underwear/product-19.jpg"
                                                    data-src="images/products/underwear/product-19.jpg" alt="Product">
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" src="images/products/underwear/product-21.jpg"
                                                data-src="images/products/underwear/product-21.jpg" alt="Product">
                                            <img class="lazyload img-hover" src="images/products/underwear/product-22.jpg"
                                                data-src="images/products/underwear/product-22.jpg" alt="Product">
                                        </a>
                                        <div class="variant-box">
                                            <ul class="product-size_list">
                                                <li class="size-item h6">XS</li>
                                    ...
                                    <div class="card-product_info">
                                        ...
                                        <ul class="product-color_list">
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                ...
                                                <img class="lazyload" src="images/products/underwear/product-21.jpg"
                                                    data-src="images/products/underwear/product-21.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Dark Violet</span>
                                                <span class="swatch-value bg-muted-violet"></span>
                                                <img class="lazyload" src="images/products/underwear/product-23.jpg"
                                                    data-src="images/products/underwear/product-23.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Sage Green</span>
                                                <span class="swatch-value bg-sage-green"></span>
                                                <img class="lazyload" src="images/products/underwear/product-24.jpg"
                                                    data-src="images/products/underwear/product-24.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Hot Pink</span>
                                                <span class="swatch-value bg-hot-pink"></span>
                                                <img class="lazyload" src="images/products/underwear/product-25.jpg"
                                                    data-src="images/products/underwear/product-25.jpg" alt="Product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" src="images/products/underwear/product-26.jpg"
                                                data-src="images/products/underwear/product-26.jpg" alt="Product">
                                            <img class="lazyload img-hover" src="images/products/underwear/product-27.jpg"
                                                data-src="images/products/underwear/product-27.jpg" alt="Product">
                                        </a>
                                        <ul class="product-action_list">
                                            <li>
                                                <a href="#shoppingCart" data-bs-toggle="offcanvas" class="hover-tooltip tooltip-left box-icon">
                                    ...
                                    <div class="card-product_info">
                                        ...
                                        <ul class="product-color_list">
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                <span class="tooltip color-filter">Dark</span>
                                                <span class="swatch-value bg-dark-charcoal"></span>
                                                <img class="lazyload" src="images/products/underwear/product-26.jpg"
                                                    data-src="images/products/underwear/product-26.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Purple</span>
                                                <span class="swatch-value bg-light-purple"></span>
                                                <img class="lazyload" src="images/products/underwear/product-28.jpg"
                                                    data-src="images/products/underwear/product-28.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">Sage Green</span>
                                                <span class="swatch-value bg-sage-green"></span>
                                                <img class="lazyload" src="images/products/underwear/product-29.jpg"
                                                    data-src="images/products/underwear/product-29.jpg" alt="Product">
                                            </li>
                                            <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                <span class="tooltip color-filter">White</span>
                                                <span class="swatch-value bg-white"></span>
                                                <img class="lazyload" src="images/products/underwear/product-30.jpg"
                                                    data-src="images/products/underwear/product-30.jpg" alt="Product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4">
                    <div class="box-image_V01 hover-img mb-xl-0 wow fadeInUp">
                        <a href="shop-default.html" class="box-image_image img-style">
                            <img src="images/section/box-image-1.jpg" data-src="images/section/box-image-1.jpg" alt="Image" class="lazyload">
                        </a>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" src="images/products/product-27.jpg"
                            ...
                            <div class="swiper-slide">
                                <div class="card-product">
                                    <div class="card-product_wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" src="images/products/product-30.jpg"
                                    ...
                                    <div class="card-product_info">
                                        <a href="product-detail.html" class="name-product h4 link">Women's T-shirts Plus Size</a>
                                        <div class="price-wrap">
                                            <span class="price-old h6 fw-normal">$79,99</span>
                                            <span class="price-new h6">$49,99</span>
                                        </div>
