...
<div class="card card-flush py-4 pb-0">
    ...
    <div class="card-body text-center pt-0">
        ...
        <div class="text-muted fs-7">Set the product back image. Only *.png, *.jpg and *.jpeg image files are accepted
        </div>
...
<div class="card card-flush py-4 pb-0">
    ...
    <div class="card-body text-center pt-0">
        ...
        <span id="p_logo" class="text-danger" style="padding-bottom: 0 !important"></span>
    </div>
</div>